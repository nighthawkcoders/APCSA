...
- Hint.  Make a simple comments "Working on it".  This can be edited by clicking on Time Stamp of post. Clicking triple dots (...) provide an Edit option and takes you to a friendly "Markdown editor".  My suggestion is comment issue and/or build personal Fastpages / GitHub pages  "_post" share the following.
