...
The index.html file is infused with standard fragments with Thymeleaf.  Thus, these files are NOT pure HTML.  The Thymeleaf pre-processor runs on all HTML files in this project before files are sent to the Web Browser.  Review comment in source code for instruction ...
...
to 
<head>
<!-- Thymeleaf inserts below into the <head> from layout/base.html -->
