...
layout: default
description: An introductory example using Backend Java application serving 3rd Party RapidAPI.  Fetching data and formatting results is a way to visualize information, in this case Covid19 statistics from across the Globe. 
