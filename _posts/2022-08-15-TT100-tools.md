...
> We need to obtain developer tools, this use brew.  
...
> VSCode install using WSL (Recommended)
...
> VSCode install using Windows. (Not Recommended)
...
### VSCode for Python (Optional, but those that took CSP may want it)
