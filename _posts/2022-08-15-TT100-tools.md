...
> <s>VSCode install for Windows. (Alternative)  This is classic Windows installation, no additional Linux additions.
...
- Install [VSCode in conventional mode](https://code.visualstudio.com/docs/setup/windows)</s>
