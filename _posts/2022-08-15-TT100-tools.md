...
> At this point the task is to prepare for Jupyter Notebooks and Kernels.
- In new WSL Command / Powershell, the WSL prompt should be <mark>prefixed with (base)</mark>.  If not, you need to go back to Anaconda install.
...
(base) shay@MSI:/mnt/c/Users/ShayM$
```
