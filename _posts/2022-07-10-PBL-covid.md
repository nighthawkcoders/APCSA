    ...
    .then(response => {
      ...
      response.json().then(data => {
          ...
          for (let row in data.countries_stat) {
            ...
            name.innerHTML = data.countries_stat[row].country_name;
            cases.innerHTML = data.countries_stat[row].cases; 
            deaths.innerHTML = data.countries_stat[row].deaths; 
            active.innerHTML = data.countries_stat[row].active_cases; 
