...
<table>
    ...
    <tr>
        ...
        <td>
            ...
            <br>
            <a href="{{site.baseurl}}/data/overview">APIs and Data</a>
        </td>
        <td>TBD</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>9</td>
        <td>
            <a href="">Inheritance❗️</a>
        </td>
        <td>
        </td>
        <td>
            <a href="">Algorithms with Polymorphism❗️</a>
        </td>
        <td>
            TBD
        </td>
    ...
    <tr>
        ...
        <td>
            <a href="https://csa.nighthawkcodingsociety.com/starters/image">Managing Images in Java</a>
        </td>
        <td>TBD</td>
    </tr>
    ...
    <tr>
        <td>7</td>
        <td>
            <a href="">ArrayList❗️</a>
        </td>
        <td>
            <a href="">Test Driven Results❗️</a>
        </td>
        <td>
            <a href="">Class/Object Operations❗️</a>
        </td>
        <td>
            <a href="https://github.com/nighthawkcoders/nighthawk_csa/wiki/Tri-2:-Tech-Talk-5-Data-Ops">Data Ops</a>
        </td>
        <td>TBD</td>
    </tr>
